 ...
 * Name: Hao Sun, Student Username: hsa117
 *
...
int doubleSize() {
  ...
  int address = doubPtr1;
  int address1 = doubPtr2;
  return address1 - address;
}
...
int withinArray(int *intArray, int size, int *ptr) {
  ...
  {
    return withinArray(intArray+1,size - 1,ptr);
  }
